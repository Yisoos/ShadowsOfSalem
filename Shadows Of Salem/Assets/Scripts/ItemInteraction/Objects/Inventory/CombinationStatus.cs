...
public class CombinationStatus
{
    ...
    [Tooltip("Escribe aquí el nombre que debe tener este objeto en \"Tags\" para poder hacer la combinación")] public string currentItemName;
    [Tooltip("Añade aquí el sprite del objeto después de arrastrar el item combinable")] public Sprite newItemStatusSprite;
    [Tooltip("¿Cual será el nombre del objeto después de hacer la combinación?")] public string newItemName;
}
